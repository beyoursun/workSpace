...
function() {
    ...
    shaketv.wxShare = function(b, c, d, e) {
        function f() {
            var f,
            g;
            return e || ( - 1 == window.location.href.indexOf(".qq.com") ? e = window.location.href: (f = a(), e = "http://yao.qq.com/tv/entry?redirect_uri={#r#}&cb41faa22e731e9b={#cb41faa22e731e9b#}", e = e.replace("{#r#}", encodeURIComponent(window.location.href)).replace("{#cb41faa22e731e9b#}", f["cb41faa22e731e9b"]))),
