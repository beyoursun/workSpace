$(function() {
    ...
    $('#selectCityDIV').on('click', function() {
        ...
        var url = window.location.protocol === 'file:' ? 'https://iicp.pingan.com.cn/icp/mobileSinglePlatform/queryCountryInfoList.do' : '/icp/mobileSinglePlatform/queryCountryInfoList.do';
        $.ajax({
            type: 'POST',
            // url: '/icp/mobileSinglePlatform/queryCountryInfoList.do',
            // url: 'https://iicp.pingan.com.cn/icp/mobileSinglePlatform/queryCountryInfoList.do', //test 
            url: url,
            dataType: 'json',
    ...
    //         });
    //         uniQueue(arr);
    //         var newArr = getData("new_arr");
    //         var select = $("#selectCityDIV");
    //         select.val(newArr);
